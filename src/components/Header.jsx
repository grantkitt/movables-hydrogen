...
export default function Header() {
  ...
  <div className="relative w-full bg-blue-200">
    ...
    <div className="relative md:absolute md:top-20 lg:top-40 xl:top-60 w-full lg:h-60 xl:h-80 text-center p-5 lg:p-10 xl:p-20 text-black drop-shadow-2xl bg-white md:bg-opacity-40 rounded-2xl">
