...
export default function Header() {
  ...
  <div className="relative w-full">
    ...
    <div className="absolute top-10 lg:top-40 xl:top-60 w-full lg:h-60 xl:h-80 text-center p-5 lg:p-10 xl:p-20 text-black drop-shadow-2xl bg-white bg-opacity-40 rounded-2xl">
